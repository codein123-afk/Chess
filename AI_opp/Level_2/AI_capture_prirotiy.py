    ...
    for a,b,c,d in moves:
        if turn=="White":
            if board[c][d]=="-P":
                ...
                if point>max_point:
                    max_point=point
                    max_row_1,max_col_1,max_row_2,max_col_2=a,b,c,d
            if board[c][d]=="-Q":
                point=9
                if point>max_point:
                    max_point=point
        ...
        if turn=="Black":
            ...
            if board[c][d]=="R":
                ...
                if point>max_point:
                    ...
                    max_row_1,max_col_1,max_row_2,max_col_2=a,b,c,d
    if point!=0:
        return (max_row_1,max_col_1,max_row_2,max_col_2)
    else:
        move=random.choice(moves)
        row_1,col_1,row_2,col_2=move
        return (row_1,col_1,row_2,col_2)
...
while running:
    ...
    if turn_ai and not promotion:
        ...
        if len(moves)==0 :
            ...
            row_1,col_1,row_2,col_2=capture_max(turn)
